...
GLfloat colorarray[]={0.0f,0.0f,1.0f,0.0,
                      0.0f,0.0f,1.0f,0.0,
                      0.0f,0.0f,1.0f,0.0,
                      0.0f,0.0f,1.0f,0.0,
                      0.0f,0.0f,1.0f,0.0,
...
void display(SDL_Window* screen){
	...
	GLfloat lightdir1[] = {0.0f,20.0f,20.0f};
	GLfloat lightcolor1[] = {1.0f,1.0f,0.0f};
	GLfloat lightdir2[] = {0.0f, -20.0f, -20.0f};
	GLfloat lightcolor2[] = {1.0f, 0.0f, 0.0f};
	...
	glUniformMatrix4fv(tempLoc,1,GL_FALSE,&trans[0][0]);
 	...
 	tempLoc = glGetUniformLocation(program,"ambient");
  	glUniform4fv(tempLoc,1,amb);

  	tempLoc = glGetUniformLocation(program,"lightcolor1");
  	glUniform3fv(tempLoc,1,lightcolor1);

  	tempLoc = glGetUniformLocation(program,"lightdir1");
  	glUniform3fv(tempLoc,1,lightdir1);

  	tempLoc = glGetUniformLocation(program,"halfvec1");
  	glUniform3fv(tempLoc,1,lightdir1);

  	tempLoc = glGetUniformLocation(program,"lightcolor2");
  	glUniform3fv(tempLoc,1,lightcolor2);

  	tempLoc = glGetUniformLocation(program,"lightdir2");
  	glUniform3fv(tempLoc,1,lightdir2);

  	tempLoc = glGetUniformLocation(program,"halfvec2");
  	glUniform3fv(tempLoc,1,lightdir2);
